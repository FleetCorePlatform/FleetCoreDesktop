        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <Card className="bg-[hsl(var(--bg-secondary))] border-red-500/30 shadow-2xl shadow-red-900/10">
            <CardHeader className="pb-3 border-b border-[hsl(var(--border-primary))]">
              <CardTitle className="text-sm font-mono uppercase tracking-wider text-[hsl(var(--text-secondary))]">
                Diagnostic Report
              </CardTitle>
            </CardHeader>
              ...
              <div className="divide-y divide-[hsl(var(--border-primary))]">
                {health.checks && health.checks.length > 0 ? (
                  health.checks.map((check, idx) => (
                    <div
                      key={idx}
                      className="flex items-center justify-between p-4 hover:bg-[hsl(var(--bg-tertiary))]/50 transition-colors"
                    >
          ...
          <div className="flex items-center gap-1.5">
            <Link to="/profile">
              ...
              >
                <User
                  size={18}
                  className={location.pathname === '/profile' ? 'text-[hsl(var(--accent))]' : ''}
                />
              </Button>
            </Link>
          </div>
