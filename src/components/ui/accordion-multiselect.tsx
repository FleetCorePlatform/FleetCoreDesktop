  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "flex flex-1 items-center justify-between h-11 text-sm transition-all hover:no-underline [&[data-state=open]>svg]:rotate-180 cursor-pointer",
          className,
        )}
        {...props}
      >
...
function AccordionMultiselectOption({
  ...
  return (
    <div
        ...
        className={cn(
            "flex items-center space-x-3 rounded-lg group cursor-pointer transition-all border border-transparent",
            "border-foreground/10 data-[state=checked]:bg-foreground/6",
            className,
      )}
      onClick={handleClick}
      {...props}
