            ...
            <div className="divide-y divide-[hsl(var(--border-primary))]">
              {drone.capabilities.map((cap, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="flex items-center justify-between p-3 hover:bg-[hsl(var(--bg-tertiary))] transition-colors"
                  >
                    <div className="flex items-center gap-3">
                      <div className="p-2 rounded-md bg-[hsl(var(--bg-tertiary))] text-[hsl(var(--text-primary))]">
                        <Icon size={14} />
                      </div>
                      <span className="text-sm font-medium text-[hsl(var(--text-secondary))] capitalize">
                        {cap}
                      </span>
                    </div>
                    <Badge
                      variant="outline"
                      className="text-[10px] border-[hsl(var(--border-primary))] text-[hsl(var(--text-muted))]"
                    >
                      INSTALLED
                    </Badge>
                  </div>
