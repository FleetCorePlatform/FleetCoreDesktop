        ...
        <div className="space-y-3 max-h-75 overflow-y-auto pr-2 custom-scrollbar">
          {loading ? (
            Array.from({ length: count }).map((_, i) => (
              <div
                key={i}
                className="flex items-center justify-between p-3 rounded-lg border border-[hsl(var(--border-primary))]"
              >
            ...
            missions.map((mission) => (
              <div
                ...
                className="flex items-center justify-between p-3 bg-[hsl(var(--bg-tertiary))] rounded-lg border border-[hsl(var(--border-primary))]"
              >
