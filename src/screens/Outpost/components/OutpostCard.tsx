import {
    MoreVertical, Trash2, Edit2, ExternalLink, Clock
} from 'lucide-react';
...
function OutpostMapPreview({ outpost }: { outpost: Outpost }) {
    ...
    const polygonPositions = outpost.area?.points?.map((p: any) => [p.y, p.x] as [number, number]) || [];
                    ...
                    <div className="flex justify-between items-start">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="bg-[hsl(var(--bg-tertiary))] border-[hsl(var(--border-primary))] text-[hsl(var(--text-primary))]">
                                ...
                                <DropdownMenuItem onClick={handleDecommissionClick} className="focus:bg-[#282e39] text-red-400 cursor-pointer">
