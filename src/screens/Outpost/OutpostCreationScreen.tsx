...
import { Coords, CreateOutpostBody } from '@/screens/Outpost/types.ts';
  ...
  const handleUseCurrentLocation = async () => {
    ...
    try {
      ...
      if (errorMsg.includes('Location services are disabled')) {
        setLocationWarning(
          'SYSTEM LOCATION OFF: Please turn on the Location toggle in your Android Quick Settings.'
        );
      } else if (errorMsg.includes('denied')) {
        setLocationWarning(
          'Permission denied. Please enable Location permissions for this app in Settings.'
        );
      } else {
