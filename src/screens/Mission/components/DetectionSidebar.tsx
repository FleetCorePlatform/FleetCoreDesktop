import {
    MapPin, Clock, Filter, ScanLine, Layers, Terminal
} from "lucide-react";
                                    ...
                                    <div className="flex justify-between items-start mb-2">
                                        <div className="flex items-center gap-2">
                                            <Badge variant="outline"
                                                className={`text-[10px] px-1.5 h-5 border-[hsl(var(--border-primary))] ${det.confidence > 0.9 ? 'text-red-400 bg-red-400/10' : 'text-amber-400 bg-amber-400/10'
                                                    }`}>
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <div className="flex-1 flex flex-col justify-between py-0.5">
                                            ...
                                            <div className="flex justify-end">
                                                <Badge variant="outline" className={`text-[10px] uppercase font-bold tracking-wider ${det.false_positive === null ? 'bg-amber-500/10 text-amber-400 border-amber-500/30' :
