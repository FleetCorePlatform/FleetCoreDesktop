    ...
    <div className="flex-none p-6 pb-2 z-10 bg-[hsl(var(--bg-primary))] border-b border-[hsl(var(--border-primary))]">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="bg-[hsl(var(--bg-secondary))] p-3 rounded-lg border border-[hsl(var(--border-primary))]">
          <div className="text-[10px] text-[hsl(var(--text-secondary))] uppercase tracking-wider mb-1">
            Total Sorties
          </div>
        ...
        <div className="bg-[hsl(var(--bg-secondary))] p-3 rounded-lg border border-[hsl(var(--border-primary))]">
          ...
          <div
            className={`text-xl font-bold font-mono ${totalThreats > 0 ? 'text-red-500' : 'text-emerald-500'}`}
          >
            {totalThreats}
          </div>
        </div>
